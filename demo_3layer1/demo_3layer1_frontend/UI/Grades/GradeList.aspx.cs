...
namespace demo_3layer1.UI.Grades
{
    public partial class GradeList : System.Web.UI.Page
    {
        ...
        private bool IsStudentRole(string role)
        {
            return SessionRoleHelper.IsInRole(role, "Student");
        }

        private bool IsStaffRole(string role)
        {
            return SessionRoleHelper.IsInRole(role, "Admin", "Teacher");
        }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                else if (IsStaffRole(role))
                {
                    ...
                    btnBack.Text = role.Equals("Teacher", StringComparison.OrdinalIgnoreCase)
                        ? "⬅️ Quay lại trang Giảng Viên"
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            ...
            else if (!string.IsNullOrEmpty(role) && role.Equals("Teacher", StringComparison.OrdinalIgnoreCase))
            {
