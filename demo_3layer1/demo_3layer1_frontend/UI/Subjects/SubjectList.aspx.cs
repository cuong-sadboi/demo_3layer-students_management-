...
namespace demo_3layer1.UI.Subjects
{
    public partial class SubjectList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            bool isAdmin = SessionRoleHelper.IsInRole(role, "Admin");
            bool isTeacher = SessionRoleHelper.IsInRole(role, "Teacher");
            ...
            btnBackAdmin.Text = isTeacher ? "⬅️ Quay lại trang Giảng Viên" : "⬅️ Quay lại trang Admin";
            btnAdd.Visible = isAdmin; // Teacher không được thêm/xóa
        ...
        {
            var role = Session["Role"] as string;
            Response.Redirect(SessionRoleHelper.IsInRole(role, "Teacher")
        ...
        protected void gvSubjects_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                var role = Session["Role"] as string;
                if (SessionRoleHelper.IsInRole(role, "Teacher"))
                {
